   ...
   PRIMARY KEY(Id_Locataire)
    ...
    CREATE TABLE Facture_electricite_batiment(
   Id_Facture_electricite_batiment INT,
   index DECIMAL(7,2) NOT NULL,
   ...
   Adresse VARCHAR2(50),
    ville VARCHAR2(50),
   cp DECIMAL(5,0),
   PRIMARY KEY(Id_Facture_electricite_batiment),
   FOREIGN KEY(Adresse, ville, cp) REFERENCES Immeuble(Adresse, ville, cp)
);   

    CREATE TABLE Facture_eau_bâtiment(
   Id_Facture_eau_bâtiment INT,
   index DECIMAL(7,0) NOT NULL,
   ...
   Adresse VARCHAR2(50),
    ville VARCHAR2(50),
   cp DECIMAL(5,0),
   PRIMARY KEY(Id_Facture_eau_bâtiment),
   FOREIGN KEY(Adresse, ville, cp) REFERENCES Immeuble(Adresse, ville, cp)
);

    CREATE TABLE Facture_gaz_bâtiment(
   Id_Facture_gaz_bâtiment INT,
   index DECIMAL(7,0) NOT NULL,
   ...
   ville VARCHAR2(50),
   cp DECIMAL(5,0),
   PRIMARY KEY(Id_Facture_gaz_bâtiment),
   FOREIGN KEY(Adresse, ville, cp) REFERENCES Immeuble(Adresse, ville, cp)
);
